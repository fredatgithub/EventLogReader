...
using WinFormEventLogReader.Properties;
...
namespace WinFormEventLogReader
{
  public partial class FormMain : Form
  {
    ...
    private void FormMainLoad(object sender, EventArgs e)
    {
      ...
      LoadEventLogComboBoxes();
    }

    private void LoadEventLogComboBoxes()
    {
      comboBoxLogName.Items.Clear();
      comboBoxLogName.Items.Add("System");
      comboBoxLogName.Items.Add("Application");
      comboBoxLogName.Items.Add("Security");
      comboBoxLogName.SelectedIndex = 0;
      comboBoxEventID.Items.Clear();
      comboBoxEventID.Items.Add("41");
      comboBoxEventID.Items.Add("1074");
      comboBoxEventID.Items.Add("1076");
      comboBoxEventID.Items.Add("6005");
      comboBoxEventID.Items.Add("6006");
      comboBoxEventID.Items.Add("6008");
      comboBoxEventID.Items.Add("6009");
      comboBoxEventID.Items.Add("6013");
    ...
    {
      textBoxEventInformation.Text = string.Empty;
      string log = comboBoxLogName.SelectedItem.ToString(); //"System";
      EventLog demoLog = new EventLog(log);
      EventLogEntryCollection entries = demoLog.Entries;
      foreach (EventLogEntry entry in entries)
      {
        textBoxEventInformation.Text += $"Level: {entry.EntryType}";
        textBoxEventInformation.Text += $"Event id: {entry.InstanceId}";
        textBoxEventInformation.Text += $"Message: {entry.Message}";
        textBoxEventInformation.Text += $"Source: {entry.Source}";
        textBoxEventInformation.Text += $"Date: {entry.TimeGenerated}";
        textBoxEventInformation.Text += $"--------------------------------";
      }
    }
  }
}